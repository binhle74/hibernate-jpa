...
public class SingleTableTest {
    private final static Logger logger = LogManager.getLogger(SingleTableTest.class);
    ...
    private List<BillingDetails> getAll() {
        TypedQuery<BillingDetails> query = entityManager.createQuery(
                "select bd from com.binhle.hjpa.inheritance.singletable.BillingDetails bd", BillingDetails.class);
